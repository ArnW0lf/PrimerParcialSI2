...
SECRET_KEY = 'django-insecure-%7(nxu7eakzzfjxbj*z%_qn8iwwf)r9l@35i+)h(2md!r5fx!('
...
# Añadir 'rest_framework.authtoken' a las aplicaciones instaladas
...
DATABASES = {
    'default': {
        ...
        'NAME': 'smartcondo_db',        # El nombre que le diste a tu BD
